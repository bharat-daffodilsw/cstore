...
cstore.directive('orderList', ['$appService', function ($appService, $scope) {
    return {
        ...
        template: '<div class="add_delete pull-left">' +
            ...
            '<button ng-click="orderDateFilter()">Filter</button><button ng-click="exportFile()">Export</button></div><div ng-click="getMore(searchby.value,search.searchContent,orderFilterData.start_date,orderFilterData.end_date)" ng-show="show.currentCursor" class="prv_btn pull-right">' +
